...
export default function Newsletter() {
    return (
        <div className='w-screen text-white flex justify-center relative mt-[8%]'>
            <div className='absolute -bottom-[50px] left-[10%] w-full'>
                <div className='md:w-[80%] md:h-[180px] h-[350px] w-full flex md:flex-row flex-col md:justify-between md:gap-0 gap-2 md:px-10 place-items-center md:p-5 m-3 relative bg-gradient-to-r from-blue-900 to-blue-400 rounded-2xl'>
