...
export default function HomePincipalCard({ content }) {
    return (
        <div className="md:mb-6 mb-5 md:px-10 px-5 overflow-hidden relative flex flex-row justify-between place-items-center md:w-[49%] w-full md:h-[100px] h-[50px] rounded-lg bg-gradient-to-r from-blue-900 to-blue-400">
