...
export default function HomeGlobal() {
    ...
    return (
        <div className='flex flex-col font-medium justify-center place-items-center md:gap-2'>
            ...
            <div className='md:p-10 p-2 px-4 pb-14 w-full h-full flex justify-center'>
