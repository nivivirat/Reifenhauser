    ...
    <div className="App mt-8 ">
      ...
      <div className="tr">
        <div className="flex flex-col hr rounded-lg bg-white md:max-w-8xl md:flex-row mm">
          ...
          <img className="fm animate__animated animate__fadeInRight" src={Serv} alt="Comprehensive Solutions for Plastic Extrusion and Converting - Reifenhauser India"></img>
        </div>
        ...
        <br></br><div className="flex flex-col rounded-lg bg-white md:max-w-8xl md:flex-row mm">
          ...
          {/* <br></br><br></br><br></br><br></br><br></br> */}
          <img className="fm  animated-box animate__animated animate__fadeInRight animate__delay-1s" src={Serv1} alt="Worldwide/Global Service Network - Reifenhauser India, plastic packaging machines"></img>
        </div>
        ...
        <br></br><div className="flex flex-col rounded-lg bg-white md:max-w-10xl md:flex-row mm">
          ...
          <img className="fm hj bbg  animated-box animate__animated animate__fadeInLeft animate__delay-2s" src={Serv3} alt="Swift Breakdown Maintenance Services - Reifenhauser India"></img>
        </div>
        <br></br><div className="flex flex-col rounded-lg bg-white md:max-w-8xl md:flex-row mm">
          <div className="flex flex-col p-6 ">
            <br></br><br></br>
          ...
          {/* <br></br><br></br><br></br><br></br><br></br> */}
          <img className="fm  animate__animated animate__fadeInRight animate__delay-3s" src={Serv4} alt="Efficient Installation and Commissioning - Reifenhauser India"></img>
        </div>
        ...
        <br></br><div className="flex flex-col rounded-lg bg-white md:max-w-10xl md:flex-row mm  ">
          ...
          <br></br><br></br><br></br>
          <img className="fm hj bbg animated-box animate__animated animate__fadeInLeft animate__delay-4s" src={Serv5} alt="Reliable AMC Services - Reifenhauser India Converting,packaging machine industry."></img>
