...
export default function Media() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (mediaData) {
          const dataArray = Object.entries(mediaData).map(([uid, { img, heading, description, routerlink }]) => ({
            id: uid,
            img,
            heading,
            description,
  ...
  return (
    <div className="App">
      ...
      <img className="media56" src={rimg} alt="image" />
            ...
            <Card className="flex flex-col rounded-lg md:max-w-full md:flex-row media5 animated-box animate__animated animate__fadeInLeft animate__delay-0.2s">
              ...
              >
                <img
                  ...
                  className="h-full max-w-full rounded-t-lg object-cover md:rounded-none md:rounded-l-lg sm:max-w-full media6"
                />
              </CardHeader>
              <CardBody>
