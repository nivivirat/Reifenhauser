    ...
    <Card className="mt-12 mb-10 ml-2 mr-2 sm:w-72 lg:w-96 md:w-96 border border-blue-500 ">
      ...
      <CardFooter className="pt-0 text-blue">
        <a href="#" className="inline-block">
          <Typography variant="text" style={{ color: '#013A98' }} className="flex items-center gap-2 test1">
            {buttonText}
          </Typography>
          <Typography variant="text" style={{ color: '#013A98' }} className="flex items-center gap-2 test90">
            {buttonTextt}
          </Typography>
          <Typography variant="text" style={{ color: '#013A98' }} className="flex items-left gap-2 test2">
            {pos}
          </Typography>
          <Typography variant="text" style={{ color: '#013A98' }} className="flex items-right gap-2 test3">
            {kl}
          </Typography>
