...
function Blog() {
  ...
  return (
    <div className="App">
      ...
      <p className="text-2xs  mt-8 kkl mr-6 ew animated-box animate__animated animate__fadeInRight">
        Manish Mehta (MM):With the help of flexo trade shops, a plate can be made available in less than four hours. Delivery in 24 hrs is quite normal in the flexo market. Whereas, a gravure cylinder would take at least four days to be delivered from the manufacturer to the converter. In most cases, if it is a matter of urgency then the brand owner either has to approach a converter who has a cylinder-making facility or move to flexo. It is much easier to manage promotions, minor changes and corrections in the job with flexo than gravure.
      </p>
      <p className="text-xl mt-8 nnm ew animated-box animate__animated animate__fadeInLeft"><strong>
      ...
      <p className="text-2xs mt-8 kkl mr-6 ew animated-box animate__animated animate__fadeInLeft">
        MM: For sure, higher the line screen, the better would be the printed image. However, most of the flexo converters are still working with 120 to 150 LPI and some have now progressed to 175 LPI.
      ...
      <p className="text-xl mt-8 nnm ew animate__animated animate__fadeInRight animate__delay-1s"><strong>
      ...
      <p className="text-xl mt-8 nnm ew animate__animated animate__fadeInLeft animate__delay-2s"><strong>
